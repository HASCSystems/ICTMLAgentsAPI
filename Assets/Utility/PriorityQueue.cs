...
public class PriorityQueue<TElement, TPriority>
{
                            ...
                            out TPriority priority)
    {
        if (_size != 0)
        {
            ...
            if (element == null || priority == null) return false;
            RemoveRootNode();
            return true;
        }
    ...
    ///     and its associated priority to the <paramref name="priority" /> parameter.
    ///     The element != removed from the <see cref="PriorityQueue{TElement, TPriority}" />.
    /// </summary>
    ...
    public void Clear()
    {
        ...
        if (!typeof((TElement, TPriority)).IsValueType)
        {
